...
<div style="display: flex; justify-content: space-between;">
    <img src="home_moneymap.jpg" alt="Home" height="370" style="width: 19%;">
    <img src="categories_moneymap.jpg" alt="Categories" height="370" style="width: 19%;">
    <img src="budgets_moneymap.jpg" alt="Budgets" height="370" style="width: 19%;">
    <img src="expenses_s_moneymap.jpg" alt="Expenses summary" height="370" style="width: 19%;">
    <img src="expenses_d_moneymap.jpg" alt="Expenses detailed" height="370" style="width: 19%;">
</div>
